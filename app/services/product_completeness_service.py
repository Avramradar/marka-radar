...
def image_quality_score( value: Any, ) -> float:
    """ Оценивает пригодность изображения без сетевого запроса. Реальная HTTP-проверка будет отдельным слоем Image Validator. """
    ...
    # Telegram file_id или другой уже
    # сохранённый внутренний идентификатор.
    return 90.0
